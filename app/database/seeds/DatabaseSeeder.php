...
class DatabaseSeeder extends Seeder
{
	...
	public function run()
	{
        ...
        $this->call('AuthMasterSeeder');
        $this->command->info('Auth seeding completed');
        $this->command->info('Seeded Tables: users, profiles, roles, role_user, permissions');
	}
}
 ...
 */
class AuthMasterSeeder extends Seeder
{
    public function run()
    {
        /**
